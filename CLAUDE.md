# CLAUDE.md — 51-MCU-Machine-Operation-Simulation
...
./build/TrajectorySystem.exe        # Ninja/Make (单配置)
# 或 ./build/Release/TrajectorySystem.exe   # MSVC (多配置)
```
...
## 注意事项
- `trajectory.txt` 优先当前目录，其次 `matlab/trajectory.txt`；CMake 自动复制到 build 目录
